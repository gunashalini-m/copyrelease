...
function invoiceDocumentHtml(invoice, options = {}) {
  ...
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><title>${escapeHtml(invoice.number)}</title>
    <style>
      ...
      .head{display:flex;justify-content:space-between;align-items:flex-start;margin:0;padding-bottom:15pt}
      ...
      .section.footer{margin-top:30pt}
      .grid{display:grid;grid-template-columns:1fr 1fr;column-gap:48px;row-gap:15pt;margin:0;align-items:start}
